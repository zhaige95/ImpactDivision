...
{
    public static GameObject CreateAvatar(GameObject avatar, int camp, bool isLocal, Vector3 position, Quaternion rotation, ConfigWeapon main = null, ConfigWeapon second = null)
    {
        ...
        //{
        //    // 本机用户的话开启相机组件，否则关闭
        //    Component.DestroyImmediate(avatarObj.GetComponentInChildren<Camera>());
        //}
