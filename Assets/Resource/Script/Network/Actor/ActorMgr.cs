...
namespace Game.Actor {
    public static class ActorMgr {
        ...
        public static GameObject NewPlayer(PlayerData playerData, bool isLocal) {
            ...
            //var obj = GameObject.Instantiate(controller.avatar, playerData.position, playerData.rotation);
            //obj.name = playerData.fd;
            //obj.GetComponent<Identity>().fd = playerData.fd;

            var obj = Factory.CreateAvatar(controller.avatar, 1, isLocal, playerData.position, playerData.rotation);
            obj.name = playerData.fd;
            obj.GetComponent<Identity>().fd = playerData.fd;
